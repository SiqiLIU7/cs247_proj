...
def _create_answer_file_for_evaluation(answer_fname='data/kdd_247/debias_track_answer.csv'):
    train = 'data/kdd_247/underexpose_train_click-%d.csv'
    test = 'data/kdd_247/underexpose_test_click-%d.csv'
    ...
    answer = 'data/kdd_247/test/underexpose_test_qtime_with_answer-%d.csv'  # not released
...
evaluate("data/kdd_247/prediction.csv",
             answer_fname='data/kdd_247/debias_track_answer.csv')